...
_LICENSE = "cc-by-4.0"
_URLS = {"FIREBALL": "https://huggingface.co/datasets/lara-martin/FIREBALL/raw/main/"}
...
class Fireball(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        with open(file_list) as f:
            ...
            data_urls = dl_manager.download(
                [url + "filtered/" + data_filename for data_filename in data_filenames]
            )
